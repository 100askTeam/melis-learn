...
static int spi_epd_test_100ask(int argc, const char **argv)
{
    ...
    //epd_100ask_display_img(gImage_full_screen_test, 240, 360);
    epd_240x360_display_img(gImage_full_screen_test, 240, 360);
    epd_240x360_refresh(EPD_LUT_GC);
    msleep(1000);
    ...
    for (index = 0; index <= 10; index++) {
            ...
            epd_240x360_display_partial(0, y_offset, 32, 96, gImage_number_1);
...
FINSH_FUNCTION_EXPORT_ALIAS(spi_epd_test_100ask, __cmd_100ask_test_spi_epd, Code to spi E-paper display test);
